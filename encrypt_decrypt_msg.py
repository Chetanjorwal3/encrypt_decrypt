...
encryptionkey = pd.read_csv(r"D:\CJ\My_GitHub\encrypt_decrypt\decodekeynew\decodekeynew.csv",
...
message = str(input("Enter tmessage to encrypt :- "))
#'It is a beautiful day to code something new. In fact, a day like any other,with new projects and ideas. Maybe also new challenges and nerve-rackings bugs. Time will tell.'
